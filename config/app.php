...
return [
    ...
    'database' => [
        'driver' => 'mysql',
        'host' => $_ENV['DB_HOST'] ?? '192.168.142.41',
        'port' => $_ENV['DB_PORT'] ?? '3307',
        'database' => $_ENV['DB_DATABASE'] ?? 'iwinback_baj7f',
        'username' => $_ENV['DB_USERNAME'] ?? 'baj7f_external_bi',
        'password' => $_ENV['DB_PASSWORD'] ?? 'W@2Tv5x9mY&D@J%srn!k',
